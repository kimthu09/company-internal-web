...
import sendEmailForgotPassword from "@/lib/reset-password/sendEmailForgotPassword";
  ...
  return (
    <div className="flex flex-col gap-8 flex-1 w-[500px]">
      <div className="flex flex-col gap-2">
        <h1 className="text-3xl font-bold tracking-tight lg:text-4xl">Quên mật khẩu</h1>
