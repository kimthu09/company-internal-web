...
public class ApplicationConst {
	public final static String FE_URL = "haha";
	...
	public final static String DEFAULT_POST_IMAGE
			= "https://firebasestorage.googleapis.com/v0/b/company-internal-web.appspot.com/o/Default%2FImage_not_available.png?alt=media";
